...
from app.controllers.sensor_controller import receive_data, get_latest_sensor_data, get_daily_average, get_sensor_data
...
routes.route('/get_latest_sensor_data', methods=['GET'])(get_latest_sensor_data)
routes.route('/get_daily_average/<date>', methods=['GET'])(get_daily_average)
routes.route('/get_sensor_data', methods=['GET'])(get_sensor_data)
